...
#. All other academic priorities take precedence over robotics,
   ...
   * BE period assignments
   * tutoring or remediation

#. Remain in the robotics lab, classroom, or bathroom (with pass).
   Get permission before going elsewhere.
#. You must have a ride to stay after school.  Your ride must be at
   school at the end of practice.
#. No shoes on the robotics field.
#. No construction, tools, or parts on the robotics field.
#. All designs require instructor approval.  The instructor checks for
   basic functionality, durability, and fitness.
#. All code revisions require instructor approval.  The instructor
   checks for bugs, clarity and maintainability of code, and potential
   hardware problems.
